  ...
  return (
    <>
      <Helmet>
        {/* Primary Meta Tags */}
        <title>
          About AlgoFusionAI | AI-Powered Trading Solutions & Company Mission
        </title>
        <meta
          name="description"
          content="Discover AlgoFusionAI's mission to revolutionize trading through AI-driven analytics. Learn about our NSE/BSE solutions, company values, and cutting-edge FinTech technology."
        />
        <meta
          name="keywords"
          content="About AlgoFusionAI, AI trading company, FinTech solutions, NSE BSE analytics, algorithmic trading mission, stock market technology"
        />

        {/* Open Graph / Facebook */}
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://algofusionai.com/about" />
        <meta
          property="og:title"
          content="About Our AI Trading Technology & Company Vision | AlgoFusionAI"
        />
        <meta
          property="og:description"
          content="Explore the story behind AlgoFusionAI - pioneers in AI-driven market analytics for NSE/BSE. Learn how we're transforming algorithmic trading."
        />
        {/* <meta property="og:image" content="https://algofusionai.com/static/og-about-company.jpg" /> */}

        {/* Twitter */}
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:site" content="@AlgoFusionAI" />
        <meta
          name="twitter:title"
          content="About AlgoFusionAI: AI Trading Innovators"
        />
        <meta
          name="twitter:description"
          content="Discover the technology and team powering India's smartest algorithmic trading platform for NSE/BSE markets."
        />
        {/* <meta name="twitter:image" content="https://algofusionai.com/static/twitter-about-company.jpg" /> */}
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            // },
            // "description": "Pioneers in AI-driven trading solutions for NSE/BSE markets",
            email: "algofusionai@gmail.com",
            // "telephone": "+91-22-12345678",
            sameAs: [
              // "https://twitter.com/AlgoFusionAI",
              "https://www.linkedin.com/company/106135364/admin/dashboard/",
              // "https://facebook.com/AlgoFusionAI"
            ],
          })}
        </script>

        {/* Additional SEO Tags */}
        <link rel="canonical" href="https://algofusionai.com/about" />
      ...
      <div className="min-h-screen bg-black text-gray-100">
        ...
        <div className="fixed inset-0 top-10 grid-pattern opacity-20"></div>
          ...
          <div className="max-w-7xl mx-auto px-4 py-3 sm:px-6 lg:px-8">
            <div className="flex items-center justify-center gap-2 text-yellow-500">
              ...
              <p className="text-sm text-center">
                ...
                carries risks. Always consult your financial advisor before
          ...
          <div className="max-w-7xl mx-auto px-4 py-32 sm:px-6 lg:px-8 relative">
            <div className="text-center animate-float">
              ...
              <div className="mt-10 flex justify-center gap-4">
                <button onClick={()=>{navigate('/screener')}} className="px-8 py-3 bg-blue-600 text-white rounded-full hover:bg-blue-700 transform hover:scale-105 transition-all duration-200 animate-glow">
                  Get Started
                </button>
        ...
        <div className="py-20 relative overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
            <div className="text-center mb-16">
              ...
              <p className="mt-4 text-blue-300/80">
                Revolutionary features that will transform your trading
                experience
              </p>
            </div>
          ...
          <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
            ...
            <div className="mt-8 text-center">
              ...
              <p className="text-sm text-blue-400/60">
                Disclaimer: Trading in financial markets involves substantial
                risk of loss. Please ensure you fully understand the risks
